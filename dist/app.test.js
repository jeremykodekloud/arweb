...
var app = require('./app'); // Adjust the path if necessary
...
describe('GET /', function () {
   ...
   */
  it('should return "Hello, Azure Pipelines and GitHub Actions!"', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var response;
 ...
 * @returns {Promise<void>} A promise that resolves when the test is complete.
 */
test('Should return a 404 status code when accessing a non-existent route', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
  var response;
  return _regeneratorRuntime().wrap(function _callee2$(_context2) {
    while (1) switch (_context2.prev = _context2.next) {
      case 0:
        _context2.next = 2;
        return request(app).get('/non-existent-route');
      case 2:
